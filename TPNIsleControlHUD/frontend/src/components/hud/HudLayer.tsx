  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      {!interactive && (
        <button
          type="button"
          className="pointer-events-auto absolute right-6 top-6 flex cursor-pointer items-center gap-2 rounded-[1px] border border-stone bg-charcoal/90 px-3 py-2 text-left text-bone shadow-hud transition-colors hover:border-amber focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber"
