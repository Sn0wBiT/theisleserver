# TPNIsleControl native WinHTTP transport

This C++ mod adds four native functions to the existing `TPNIsleControl`
Lua mod:
...
```text
TheIsle\Binaries\Win64\ue4ss\Mods\TPNIsleControl\dlls\main.dll
```
